...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 text-white bg-black fixed z-20'>
      <div>
        <h1 className='text-5xl font-signature ml-2'>Sudais Amin</h1>
      </div>
      ...
      {nav && 
      <ul className='flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800 text-gray-500 transition-all'>
        {links.map(({ id, link }) => {
